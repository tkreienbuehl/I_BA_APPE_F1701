...
\begin{tabular}{|l|l|l|l|l} \rowcolor{gray!50}
	...
	\end{tabular} &
	\begin{tabular}{l}
		- Layerarchitektur ist einer ersten Version\\
		 vorhanden\\
		- Klassendiagramm für mind. UC 'Bestellungen\\ einsehen'\\
		- Definition der Interfaces \& DTOs zwischen \\
		BL-DL und BL-PL
	\end{tabular} \\ 
	\hline 
	I8-12 & 
	...
	\end{tabular} &
	\begin{tabular}{l}
		- PL: Anzeige der Details einer Bestellung in\\
	...
	\end{tabular} &
	\begin{tabular}{l}
		- zu allen UseCases gem. Übersicht und Anforder-\\ungsliste sind folgende Punkte beschrieben:\\
		-- Kurzbeschrieb und bei UC 'Bestellung' detail-\\lierter\\
	...
	\begin{tabular}{l}
		...
		- PMP mit Organisation, Risikoliste, Anforder-\\ungen ist in einer ersten Version vorhanden
	\end{tabular} \\ 
\end{tabular}\\
\clearpage
