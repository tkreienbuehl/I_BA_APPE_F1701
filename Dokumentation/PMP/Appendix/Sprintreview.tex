...
\begin{tabular}{|l|l|l|} \rowcolor{gray!50}
	...
	\begin{tabular}{l}
		...
		Angelieferte Artikel werden mengentechnisch im \\Filiallager angepasst / erhöht.
	\end{tabular} \\ 
	\hline
	I8-8 & 
	...
	Nachbestellung auslösen &
	\begin{tabular}{l}
		Die Nachbestellung wurde beim Unterschreiten der \\Mindestmenge von 2 Elementen automatisch ausge-\\löst.\\
