...
\tableofcontents
\clearpage
\input{Ziele/Projektubersicht.tex}
\clearpage
\input{Ziele/Projektfuhrung.tex}
\clearpage
\input{Ziele/Projektunterstutzung.tex}
\clearpage
\input{Testing/Testkonzept.tex}
\clearpage
\section{Anhänge}
\input{Testing/Testprotokolle.tex}
\clearpage
\input{Appendix/Sprintplanung.tex}
\clearpage
\input{Appendix/Sprintreview.tex}
\clearpage
\end{document}
