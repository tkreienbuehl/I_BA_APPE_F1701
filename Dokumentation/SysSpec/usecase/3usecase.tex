...
%Zeile
	...
	\begin{tabular}{l}
		...
		2.	Kunde auswählen. \\
		3.	Schaltfläche "Neue Bestellung erfassen" oder "Bestellungen ansehen" auswählen. \\
		4. 	Produkt auswählen (Dropdown). \\
		5. 	Anzahl eingeben. \\
		6.	Schaltfläche "Hinzufügen" oder "Löschen" betätigen. \\
		7.	Falls mehrere Produkte Schritt 4 bis 6 wiederholen.\\
		8.  Schaltfläche "Bestellung abschliessen" betätigen.
