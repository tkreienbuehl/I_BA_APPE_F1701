...
%Zeile
	...
	\begin{tabular}{l}
		Der Lagerbestand wird mit dem definierten Grenzwert verglichen\\
		 und eine Bestellung ausgelöst.
	\end{tabular}
\\ \hline
%Zeile
	\textbf{Akteure}   		 &
...
%Zeile
	\textbf{Sonderfälle}			 &
	\begin{tabular}{l}
		- Lagerbestand ist über minimalen Lagerbestand \\
		-> keine Nachbestellung auslösen.
	\end{tabular}
\\ \hline	
%Untere Abgrenzung
\end{tabular}
